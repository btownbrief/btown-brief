...
const SHELL_URLS = [
  ...
  './js/modes/whatnow.js', './js/modes/ig.js', './js/modes/sports.js',
  './js/whatnow-engine.js', './js/whatnow-data.js',
  './data/wander-pool.json', './data/music.json',
  './data/whatnow.json', './data/instagram.json', './data/podcast.json', './data/sports.json',
];
