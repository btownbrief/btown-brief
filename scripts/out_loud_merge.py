#!/usr/bin/env python3
"""Merge reviewed Btown Out Loud stories into data/out-loud.json.
...
edits applied), and writes them into data/out-loud.json. Existing pins with
...
def main():
    ...
    for pid, pin in drafts.items():
        ...
        out["coord_verified"] = f"review-{today}"
        out["enabled"] = True
